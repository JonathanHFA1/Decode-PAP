    ...
    <Card sx={{ maxWidth: 345, bgcolor: '#252525' }}>
      ...
      <CardActions disableSpacing>
        <div className="flex gap-[6rem]">
          ...
          <div>
        <button onClick={() => setOpenModal(true)} className='bg-[#FF4E16]  hover:bg-orange-700 h-[43px] rounded-full py-2 px-4 font-bold text-white'>Comprar</button>
      </div>
      ...
      <div className="z-50 px-4 py-6 text-left bg-[#252525] rounded-lg">
              <h1 className="mb-4 text-2xl font-medium leading-6 text-white">
                Coloque seus dados de compra
              </h1>
