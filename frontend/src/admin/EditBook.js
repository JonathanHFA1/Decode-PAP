    ...
    <>
      <Box sx={{ bgcolor: 'white', padding: '20px 200px' }}>
        ...
        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
          ...
          <Box sx={{ mb: 3 }}>
            <ReactQuill theme="snow" placeholder={'Write the post content...'} modules={modules} value={values.content} onChange={(e) => setFieldValue('content', e)} />
